...
for i in range(1,510):
    #img파일 가져오기
    path="C:\\Users\\inaee\\Desktop\\2020-1MAKERS\\OCR\\square_padding\\square_"+str(i)+".jpg"
    ...
    # 이미지 저장하기
    cv2.imwrite("C:\\Users\\inaee\\Desktop\\2020-1MAKERS\\OCR\\square_padding\\square_"+str(num)+".jpg",img_re2)
    num=num+1
    print("완료")
